...
elapse_sampling_ratio = DAC_elapse_period_us / sampling_us;
ht_simulation = zeros(1, uint32(elapse_sampling_ratio * 3 + 1));
% set ht pulse at specific point
ht_simulation(1, 1) = 0.5;
ht_simulation(1, uint32(1.5 * elapse_sampling_ratio) + 1) = 0.4;
ht_simulation(1, uint32(2.5 * elapse_sampling_ratio) + 1) = 0.35;
ht_simulation(1, uint32(3 * elapse_sampling_ratio) + 1) = 0.3;
